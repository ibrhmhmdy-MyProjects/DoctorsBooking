...
const TopDoctors = () => {
  ...
  return <div className="flex flex-col items-center gap-4 my-6 text-gray-900 md:mx-10">
    ...
    <button className="bg-blue-50 px-12 py-3 rounded-full mt-10 hover:font-medium">More</button>
  </div>;
};
